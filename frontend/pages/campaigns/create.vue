  ...
  <v-stepper v-model="e1" vertical>
    ...
    <v-stepper-content step="1">
      <v-form ref="form" class="form-page" v-model="valid" lazy-validation>
        <v-text-field v-model="title" :rules="nameRules" :counter="150" label="Title" required></v-text-field>
        <v-textarea auto-grow v-model="description" :counter="250" label="Description" required></v-textarea>
        <v-select
          v-model="select"
          :items="items"
        ...
        <v-text-field
          ...
          required
        ></v-text-field>
        <v-text-field v-model.number="bounty" box label="Bounty EOS" type="number"></v-text-field>
      </v-form>
    ...
    <v-stepper-content step="2">
      <v-card class="mb-5">
        <v-form ref="form" class="form-page" v-model="valid" lazy-validation>
          <v-text-field v-model.number="maxchecks" box label="Max checks" type="number"></v-text-field>
          <v-menu
      ...
      <v-btn color="pink" @click="e1 = 3" dark>Stake Bounty</v-btn>
    </v-stepper-content>
